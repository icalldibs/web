...
export const heroScenarios = [
  {
    ...
    location: "Miami, FL",
    rating: "1.1",
    message: "Cheapest PS5 nearby: $270 with a controller. Deal?",
    detail: "1.1 mi away",
    reply: "let’s make it happen!",
  },
  {
    id: "jordans",
    ...
    rating: "1.1",
    userUpload: true,
    message: "Similar Jordans sell for $100 nearby. Want me to list yours?",
    detail: "12 buyers nearby",
    reply: "let’s list my Jordans",
  },
  {
    id: "tickets",
